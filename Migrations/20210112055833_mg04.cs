        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TraineeId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Round = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: false),
                    CourseName = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    TSPName = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    BatchNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_OrderMasters_MastId",
                        column: x => x.MastId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolClassID = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
